...
export default function AdminNGOEditPage() {
  ...
  const { data: ngo, isLoading } = useQuery({
    ...
    enabled: !!ngoId && status === 'authenticated' && (session?.user?.role === 'ADMIN' || session?.user?.role === 'MODERATOR'),
  })
  ...
  const updateMutation = useMutation({
    ...
    onSuccess: () => {
      toast.success('НКО успешно обновлено!')
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow flex items-center justify-center">
          <div className="text-center">
            ...
            <button onClick={() => router.push('/admin/ngo')} className="btn-primary">
              Вернуться к списку
            </button>
          </div>
        </main>
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow bg-gray-50 py-12">
        <div className="container-custom max-w-4xl">
          <div className="mb-8">
            <h1 className="text-3xl font-bold mb-2">Редактирование НКО (Админ)</h1>
            <p className="text-gray-600">Полный доступ к редактированию всех полей</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-8">
            {/* Status */}
            <div className="card">
              <h2 className="text-xl font-bold mb-6">Статус</h2>
              <div>
                <label className="label">Статус НКО *</label>
                <select
            ...
            {/* Logo */}
            <div className="card">
              <h2 className="text-xl font-bold mb-6">Логотип организации</h2>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Укажите прямую ссылку на изображение логотипа организации
                </p>
              </div>
            </div>
